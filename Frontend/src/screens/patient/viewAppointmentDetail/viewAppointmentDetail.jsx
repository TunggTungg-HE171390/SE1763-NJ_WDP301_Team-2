...
const PatientViewAppointmentDetail = () => {
    ...
    const fetchAppointmentHistory = async (psychologistId) => {
        ...
        try {
            const history = await appointmentApi.getPatientAppointmentsWithPsychologist(
                user.id, 
                psychologistId
            );
...
export default PatientViewAppointmentDetail;
