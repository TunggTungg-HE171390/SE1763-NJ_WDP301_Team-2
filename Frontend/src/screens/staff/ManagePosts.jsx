...
const ManagePosts = () => {
    ...
    const toggleVisibility = async (postId) => {
        ...
        try {
            ...
            setPosts((prevPosts) =>
                prevPosts.map((post) => (post._id === postId ? { ...post, status: updatedStatus } : post))
            );
        } catch (error) {
    ...
    return (
        <Container className="mt-5">
            ...
            <Button variant="info" className="me-2 mb-2 justify-end" onClick={() => navigate("/staff/create-post")}>
                Create new post
            </Button>
                                ...
                                {currentPosts.length > 0 ? (
                                    currentPosts.map((post) => (
                                        <tr key={post._id}>
                                            ...
                                            {/* Chuyển đổi thời gian thành dạng đọc được */}
                                            <td>
