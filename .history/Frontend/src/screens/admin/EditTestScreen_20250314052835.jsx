  ...
  useEffect(() => {
    const fetchTestData = async () => {
      try {
        ...
        console.log("Test Response:", testResponse);  // Log kết quả trả về
        ...
        console.log("Question Response:", questionResponse.data);  // Log kết quả trả về
        // Set test data
        ...
        // setCateName(categoryResponse.categoryName);
      } catch (error) {
    ...
    <Container>
      ...
      <Card className="text-sm text-left mb-4" style={{ marginBottom: '20px', padding: '20px' }}>
        ...
        {questionData.questions?.map((question, index) => (
          {questionsArray.questions?.map((question, questionIndex) => (
