...
export function EditTestScreen() {
    ...
    const handleSaveTest = async () => {
        try {
            ...
            console.log("testUpdateResponse", testUpdateResponse);
            ...
            //   setCategoryId(testUpdateResponse.categoryId); // Cập nhật categoryId sau khi bài kiểm tra đã được cập nhật
