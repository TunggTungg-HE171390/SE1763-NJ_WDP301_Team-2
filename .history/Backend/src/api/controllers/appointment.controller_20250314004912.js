...
const cancelScheduleByPatient = async (req, res, next) => {
    try {
        ...
        if(appointment.status === "Con  firmed") {
        ...
        // statusMessage = `🔴 Cuộc hẹn của bạn với bác sĩ ${appointment.psychologistId.fullName} vào lúc ${reScheduleTime} đã bị hủy.`
        ...
        // statusMessage = `🔴 Cuộc hẹn của bạn với bệnh nhân ${appointment.patientId.fullName} vào lúc ${reScheduleTime} đã bị hủy.`
