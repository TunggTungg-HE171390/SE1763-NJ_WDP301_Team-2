...
Tâm Giao.
  ...
  Chào ${username},
  Chúng tôi xin thông báo rằng cuộc hẹn của bạn với bác sĩ [Tên Bác Sĩ] vào lúc [Thời gian cuộc hẹn] ngày [Ngày] đã bị hủy. Lý do cuộc hẹn bị hủy là do [Lý do hủy, nếu cần thiết].

Chúng tôi thành thật xin lỗi về sự bất tiện này và rất mong bạn sẽ sắp xếp lại cuộc hẹn mới trong thời gian tới. Nếu bạn muốn đặt lại lịch, xin vui lòng liên hệ với chúng tôi qua [Thông tin liên hệ] hoặc truy cập vào hệ thống đặt lịch của chúng tôi tại [Website hoặc nền tảng đặt lịch].
